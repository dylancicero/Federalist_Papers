...
# Evaluate number of characters in each author's text string
len(hamilton)
len(madison)
len(jay)
...
# Define function to generate third-order Gauss Markov frequency distribution for a given text
# and write an 100-word passage based on random selection of the next word from the frequency
# distribution
